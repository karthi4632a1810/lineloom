...
export const overallVisitSeconds = (tracking = {}, token = {}) => {
  const startMs = toMs(tracking.waiting_start ?? tracking.consult_start);
  const end = resolveVisitCompletedAt(tracking, token);
